...
//    $jData = json_decode($data);
    ...
    $act_type =     $data[array_search("ACTION_TYPE", $columns)];
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="one-action-images-holder">
                            ...
                            <div class="one-action-image-list">
                                ...
                                $images_html = '<div class="one-action-image-list-item" alt="'.$act_name . ' Купить билет" data-url="'.$poster.'" data-type="image"><div style="background-image: url('.$poster.')" class=""></div></div>';
                                ...
                                if(strlen($images_list) > 0){
                                    ...
                                    foreach ($images as $key1 => $value1){
                                        ...
                                        if(strpos($value1, 'youtube.com')){
                                            ...
                                            $images_html .= '<div class="one-action-image-list-item" alt="'.$act_name . ' Купить билет" data-url="'.$value1.'" data-type="image"><div style="background-image: url('.$value1.')" class=""></div></div>';
                                        }
...
//                                var_dump($actor_columns);
                            ...
                            <?php if($act_id == 3718): ?>
                                ...
                                <div class="denzvezd-info">
                                    <h3>Он-лайн:</h3>
                                    <p><i class="fa fa-desktop"></i>&nbsp;&nbsp;Виртуальное присутствие на форуме</p>
                                    <p><i class="fa fa-question"></i>&nbsp;&nbsp; Возможность задавать вопросы выступающим</p>
                                    <p><i class="fa fa-video-camera"></i>&nbsp;&nbsp; Персональная ссылка на видео трансляцию выступления</p>

                                    <h3>Серебряный:</h3>


                                    <p><i class="fa fa-user"></i>&nbsp;&nbsp; Живое участие</p>
                                    <p><i class="fa fa-microphone"></i>&nbsp;&nbsp; Выступления форума</p>
                                    <p><i class="fa fa-coffee"></i>&nbsp;&nbsp; Кофе-брейки</p>
                                    <p><i class="fa fa-bullhorn"></i>&nbsp;&nbsp; Участие в розыгрыше рекламных постов от спикеров</p>
                                    <p><i class="fa fa-glass"></i>&nbsp;&nbsp; Вход на afterparty</p>
                                    <p><i class="fa fa-video-camera"></i>&nbsp;&nbsp; Персональная ссылка на видео трансляцию выступления</p>

                                    <p>Сайт мероприятия: <a target="_blank" href="http://denzvezd.ru?utm_source=mirbileta_privet_ot_sany">denzvezd.ru</a></p>
                ...
                <div class="row" id="mb-launchFullScreen">
                    <div class="col-md-12 <?php echo ($is_wo)? 'widget_without_places' : ''; ?>">
                        ...
                        <?php
                            ...
                            ?>
                                ...
                                <div class="net-bilet">По наличию и заказу билетов звоните +7 (499) 391-61-97</div>
                        ...
                        ?>
                                ...
                                <?php
                                    if($is_wo){
                                        ...
                                        echo '<div class="one-action-widget-tip">Выберите входые билеты</div>';

                                    }else{
                                        echo '<div class="one-action-widget-tip">Выберите билеты на интерактивной схеме зала</div>';
                                    }
